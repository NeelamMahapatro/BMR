	             		 ...
	             		 <!-- Brand and toggle get grouped for better mobile display -->
	              			<div class="navbar-header">
	                            ...
	                            <a class="navbar-brand sticky-logo" href="index.html">
	                  				<img src="img/logo.png" alt="BMR" title="Blackbamba" height="55px" width="110px">
								</a>
	              			</div>
          ...
          <div class="row">
                ...
                <div class="section-headline text-center">
                    <h2>BAJA</h2>
            			...
            			<center><h2 style="color:black;">World's leading motorsport engineering competition</h2></center>
              </div>
            </div>
          	...
          	<div class="row">
        		...
        		<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<ul style="padding-left: 20px;    text-indent: 2px;    list-style: none;    list-style-position: outside;">
	                    ...
	                    <li style=" margin: 4px 0px;    text-transform: uppercase;">&#9830; BRAZIL</li>
	                    <li style=" margin: 4px 0px;    text-transform: uppercase;">&#9830; SOUTH AFRICA</li>
						<li style=" margin: 4px 0px;    text-transform: uppercase;">&#9830; SOUTH KOREA</li>
					</ul>
        		</div>
      		</div>
      		<br>
				...
				<br>
       		    <div class="awesome-project-content">
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/2.jpg">    
                    					  <h4 style="color: white;">Technical Inspection</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/1.jpg">    
                    					  <h4 style="color: white;">Cost Analysis</h4>                 						
                   						</a>
                					</div>
                				</div>
              				</div>
          			...
          			<div class="col-md-4 col-sm-4 col-xs-12 design development">
            			<div class="single-awesome-project">
              				<div class="awesome-img">
                				<a href="#"><img src="img/bmr06.jpg" alt="" style="max-width: 100%;  max-height: 300px;"/></a>
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/bmr06.jpg">    
                    					  <h4 style="color: white;">Sales Presentation</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/4.jpg" style="max-width: 100%;  max-height: 300px;">    
                    					  <h4 style="color: white;">Brake test</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/4.jpg">    
                    					  <h4 style="color: white;">Acceleration</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="bmr4.jpg">    
                    					  <h4 style="color: white;">Hill climb/ Traction event</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
                				...
                				<div class="add-actions text-center">
                  					<div class="project-dec">
                    					<a class="venobox" href="img/imp.jpg">    
                    					  <h4 style="color: white;">Manoeuvrability and Suspension & Traction test</h4>                  						
                   						</a>
                					</div>
                				</div>
              				</div>
